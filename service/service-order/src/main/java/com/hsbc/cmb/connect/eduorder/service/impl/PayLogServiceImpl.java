...
import com.hsbc.cmb.connect.eduorder.mapper.PayLogMapper;
import com.hsbc.cmb.connect.eduorder.service.OrderService;
import com.hsbc.cmb.connect.eduorder.service.PayLogService;
import com.hsbc.cmb.connect.eduorder.utils.HttpClient;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map createNatvie(String orderNo) {
        try {
            ...
            throw new FileEmptyException(20001,"生成二维码失败");
        }
